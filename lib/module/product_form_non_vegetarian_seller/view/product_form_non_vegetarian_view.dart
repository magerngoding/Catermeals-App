...
class ProductFormNonVegetarianView extends StatelessWidget {
  const ProductFormNonVegetarianView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ProductFormNonVegetarianController>(
      init: ProductFormNonVegetarianController(),
      builder: (controller) {
