...
class ProductListNonVegetarianBuyer2View extends StatefulWidget {
  ...
  Widget build(context, ProductListNonVegetarianBuyer2Controller controller) {
  ...
  @override
  State<ProductListNonVegetarianBuyer2View> createState() =>
      ProductListNonVegetarianBuyer2Controller();
}
